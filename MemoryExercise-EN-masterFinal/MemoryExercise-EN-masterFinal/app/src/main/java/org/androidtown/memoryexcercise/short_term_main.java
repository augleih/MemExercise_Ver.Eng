...
public class short_term_main extends AppCompatActivity {

    //버튼 UI

    ImageButton enterEx1Btn, enterEx2Btn, enterEx3Btn, enterEx4Btn, enterEx5Btn,enterEx7Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_short_term_main);
        //클래스
        numRemember = new NumRemember();
        numRemeberQuiz = new NumRemeberQuiz();
        /*
        final DBHelper dbHelper = new DBHelper(getApplicationContext(),"PointManager.db",null,1);
        dbHelper.insert("game3",0);
        dbHelper.insert("game4",0);
        dbHelper.insert("game5",0);
        */
        //클래스
        ...
        enterEx7Btn = (ImageButton) findViewById(R.id.nameRemember);
        ...
        enterEx7Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),LevelSelect.class);
