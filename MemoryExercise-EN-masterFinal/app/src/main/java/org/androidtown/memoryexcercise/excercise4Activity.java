...
public class excercise4Activity extends AppCompatActivity {
    ...
    int count = 4;
    int gameCount;
    static float level=(float)1 ;//난이도 조절. ////////////////////////강지호
    static int sublevel = 5;////////////////////////강지호
    //과일 이미지뷰
    ImageView fruit1;
    ImageView fruit2;
    ImageView fruit3;
    ...
    ImageView sfruit1Answer;
    ImageView sfruit2Answer;
    ImageView sfruit3Answer;
    ImageView sfruit4Answer;
    ImageView sfruit5Answer;
    ImageView sfruit6Answer;
    ImageView sfruit7Answer;
    ImageView sfruit8Answer;
    ImageView sfruit9Answer;
...
//pointText2.setVisibility(View.INVISIBLE);//5/26
    ...
    public void randomFruits(ImageView[] fruits, ImageView[] fruitsAnswerImages) {
        ...
        randNumber2 = (int) (Math.random() * 10000%6);
    ...
    public void setStar(int current){
        ...
        toEdit = sh.edit();
        star = sh.getInt("game4level2", 0);
        if(current > star)
            toEdit.putInt("game4level2",current);
        toEdit.commit();
