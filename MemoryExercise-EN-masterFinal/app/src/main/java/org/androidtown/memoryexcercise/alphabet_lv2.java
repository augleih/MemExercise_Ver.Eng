...
public class alphabet_lv2 extends AppCompatActivity {

    TextView gameExplain, textCenter, textQuestion, noti, scoreText,  stageText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alphabet_lv2);
...
//                }
    ...
    void memoryTest() {
        String suggestion = answer[0] + alphabet[random.nextInt(26)] + alphabet[random.nextInt(26)] + alphabet[random.nextInt(26)];
        int chance;
        ...
        homebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alphabet_lv2.super.onBackPressed();
            }
        });
        ...
        for (int i = 0; i < 4; i++) {
            String tmp = "";
            for (int j = 0; j < 4; j++) { // 무작위로 알파벳 3개를 골라서 만든다.
                if(random.nextBoolean()){
                    tmp += answer[random.nextInt(4)];
                }
                else {
                ...
                public void onClick(View v) {
                    if (idx == aIdx) { // 정답을 선택
                        ...
                        //게임 종료 알림
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(alphabet_lv2.this);
    ...
    public void setStar(int current){
        ...
        toEdit = sh.edit();
        star = sh.getInt("game5level2", 0);
        if(current > star)
            toEdit.putInt("game5level2",current);
        toEdit.commit();
