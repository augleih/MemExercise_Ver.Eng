...
public class zoo_long_term_answering_lv2 extends AppCompatActivity {
    String[] suggestAct = {"mustache", "glasses", "necktie", "ribbon"};
    ...
    int animal, act, answer, answer2, currentPoint;
    boolean ans1, ans2;
    TextView taskText;
    Random random;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zoo_long_term_answering_lv2);
        ...
        taskText.setText("(      ) and (      ) were shown yesterday");
            ...
            answerBtn[i].setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    if (idx == aIdx) { // 정답을 선택
                        ...
                        //게임 종료 알림
                        AlertDialog.Builder builder = new AlertDialog.Builder(zoo_long_term_answering_lv2.this);
